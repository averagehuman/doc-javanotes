...
:doc:`Section 5.5</5/s5>` covers the central ideas of object-oriented programming:
...
entire hierarchies of classes from scratch. :doc:`Section 5.6</5/s6>` and
:doc:`Section 5.7</5/s7>` cover some of the many details of object oriented
