...
While we will not study objects in detail until:doc:`Chapter 5</5>`, it will be
...
been chunked together and given a name. In :doc:`Chapter 4</4>`, you'll learn
...
doing real object-oriented programming in :doc:`Chapter 5</5>`, I will prefer
...
defining new classes; you will learn how to do that in :doc:`Chapter 5</5>`.
