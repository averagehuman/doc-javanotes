...
which were covered in :doc:`Chapter 8</8/index>`. Many of the subroutines that are
...
in the :doc:`Chapter 12</12/index>`. We will look at the basic networking API in this
